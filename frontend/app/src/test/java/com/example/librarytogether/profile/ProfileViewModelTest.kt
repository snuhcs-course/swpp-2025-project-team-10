...
class ProfileViewModelTest {
    ...
    fun loadUserProfile_success_loads_all_data() = runTest {
        ...
        val books = listOf(Book(id = "b1", title = "T", authors = listOf("A"), cover_image = null, publisher = null, isbn = null, publicationId = null))
        val reviews = listOf(Review(1, "B", "A", "U", "", "C"))
        val wishlist = listOf(Book(id = "w1", title = "W", authors = listOf("A"), cover_image = null, publisher = null, isbn = null, publicationId = null))
    ...
    fun refreshBooks_success() = runTest {
        ...
        val newBooks = listOf(Book(id="b2", title="T", authors=listOf("A"), cover_image = null, publisher = null, isbn = null, publicationId = null))
    ...
    fun refreshWishlist_success() = runTest {
        ...
        val newWishlist = listOf(Book(id="w2", title="Wish", authors=listOf("A"), cover_image = null, publisher = null, isbn = null, publicationId = null))

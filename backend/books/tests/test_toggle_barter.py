...
def test_toggle_barter_book_not_found():
    ...
    client = APIClient()
    user = User.objects.create(username="owner", email="owner@test.com", first_name="O", last_name="wner")
    client.force_authenticate(user)
    
    # Invalid UUID
    res = client.patch("/library/books/00000000-0000-0000-0000-000000000001/toggle-barter/")
